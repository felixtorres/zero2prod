...
impl SubscriberName {
    // Returns an instance of `SubscriberrName` if the input satisfies all
    ...
    pub fn parse(s: String) -> Result<SubscriberName, String> {
        ...
        // A grapheme is defined by the Unicode standard as a "user-perspective"
    ...
    pub fn inner_mut(&mut self) -> &mut str {
        // The caller gets a mutuable reference to the inner string.
